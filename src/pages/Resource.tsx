...
const Resource = () => {
  ...
  return (
    <div className='p-8'>
      <h1 className='text-2xl md:text-3xl lg:text-4xl font-bold text-gray-500  mb-4 text-center'>Resources</h1>
      ...
      <div className='mb-8'>
        <h2 className='text-xl md:text-2xl lg:text-3xl font-bold text-gray-500  mb-4'>Articles</h2>
      ...
      <div className='mb-8'>
        <h2 className='text-xl md:text-2xl lg:text-3xl font-bold text-gray-500 mb-4'>Videos</h2>
        <ul className='list-disc list-inside'>
      ...
      <div className='mb-8'>
        <h2 className='text-xl md:text-2xl lg:text-3xl font-bold text-gray-500  mb-4'>E-Books</h2>
        <ul className='list-disc list-inside'>
      ...
      <div className='mb-8'>
        <h2 className='text-xl md:text-2xl lg:text-3xl font-bold text-gray-500  mb-4'>External Links</h2>
        <ul className='list-disc list-inside'>
