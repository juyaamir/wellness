...
const About = () => {
  return (
    <div className='p-8'>
      <h1 className='text-4xl font-bold text-gray-500 text-center mb-4'>About Us</h1>
      ...
      <h2 className='text-3xl font-bold text-gray-500 mb-2'>Our Mission</h2>
      <p className='text-lg mb-4'>
      ...
      <h2 className='text-3xl font-bold text-gray-500 mb-2'>Our Vision</h2>
      <p className='text-lg mb-4'>
      ...
      <h2 className='text-3xl font-bold text-gray-500 mb-2'>Our Values</h2>
      ...
      <h2 className='text-3xl font-bold text-gray-500 mb-2'>Meet Our Team</h2>
      ...
      <h2 className='text-3xl font-bold text-gray-500 mb-2'>Contact Us</h2>
      <p className='text-lg mb-4'>
